export const en = {
  ...
  voiceKarl: 'Deep and clear narrative male',
  voiceLeonie: 'Clear and professional female',
  voiceOtto: 'Young and outgoing male',
  voiceLena: 'Young and very friendly female',
  voiceLana: 'Meditative soft female',
  voiceMila: 'Young female',
  voiceMario: 'Soft male voice',
  voiceMarco: 'Mature and pensive male',
  voiceGiovanni: 'Young and friendly male',
  voiceGiuseppe: 'Senior expressive male',
  voiceSamanta: 'Young and friendly middle-aged female',
  voiceMartin: 'Very deep and slow Spanish male',
  voiceBruno: 'Fast and neutral male',
  voiceRoberto: 'Middle-aged interested narrative male',
  voiceRegina: 'Elderly and composed female',
  voiceRosa: 'Young and friendly female',
  voiceSofia: 'Young and seductive female',
  voiceVira: 'Ukrainian middle-aged female',
  voiceOleksandr: 'Ukrainian middle-aged composed male',
  voiceAnton: 'Energetic male',
  ...
  audioAllVoices: 'All Voices',
  audioLanguageVoices: '{0} Voices',
  
  // Voice descriptions
  voiceAutumnDescription: 'Soft, clear narrative female',
  voiceLauraDescription: 'ASMR soothing female',
  voiceRogerDescription: 'Deep and authoritative',
  voiceBillDescription: 'Calm and soothing male',
  voiceAdamDescription: 'Deep British male',
  voiceAllissonDescription: 'Emotional and expressive millennial female',
  voiceDakotaDescription: 'Middle-aged African-American female',
  voiceEmilyDescription: 'Young friendly female',
  voiceFrederickDescription: 'Professional, well-spoken British male',
  voiceJohnDescription: 'Narrative middle-aged male',
  voiceJasonDescription: 'Neutral, clear Australian male',
  voiceAgatkaDescription: 'Polish bright and cheerful female with clear voice',
  voiceKarlDescription: 'Deep and clear narrative male',
  voiceLeonieDescription: 'Clear and professional female',
  voiceOttoDescription: 'Young and outgoing male',
  voiceLenaDescription: 'Young and very friendly female',
  voiceLanaDescription: 'Meditative soft female',
  voiceMilaDescription: 'Young female',
  voiceMarioDescription: 'Soft male voice',
  voiceMarcoDescription: 'Mature and pensive male',
  voiceGiovanniDescription: 'Young and friendly male',
  voiceGiuseppeDescription: 'Senior expressive male',
  voiceSamantaDescription: 'Young and friendly middle-aged female',
  voiceMartinDescription: 'Very deep and slow Spanish male',
  voiceBrunoDescription: 'Fast and neutral male',
  voiceRobertoDescription: 'Middle-aged interested narrative male',
  voiceReginaDescription: 'Elderly and composed female',
  voiceRosaDescription: 'Young and friendly female',
  voiceSofiaDescription: 'Young and seductive female',
  voiceViraDescription: 'Ukrainian middle-aged female',
  voiceOleksandrDescription: 'Ukrainian middle-aged composed male',
  voiceAntonDescription: 'Energetic male',
}; 