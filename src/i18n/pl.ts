export const pl = {
  ...
  voiceKarl: 'Głęboki i jasny narracyjny męski',
  voiceLeonie: 'Jasny i profesjonalny kobiecy',
  voiceOtto: 'Młody i towarzyski męski',
  voiceLena: 'Młoda i bardzo przyjazny kobiecy',
  voiceLana: 'Medytacyjny miękki kobiecy',
  voiceMila: 'Młoda kobieta',
  voiceMario: 'Miękki męski głos',
  voiceMarco: 'Dojrzały i zamyślony męski',
  voiceGiovanni: 'Młody i przyjazny męski',
  voiceGiuseppe: 'Starszy ekspresyjny męski',
  voiceSamanta: 'Młoda i przyjazna kobieta w średnim wieku',
  voiceMartin: 'Bardzo głęboki i wolny Hiszpański',
  voiceBruno: 'Szybki i neutralny męski',
  voiceRoberto: 'Mężczyzna w średnim wieku z zainteresowaną narracją',
  voiceRegina: 'Starsza i opanowana kobieta',
  voiceRosa: 'Młoda i przyjazna kobieta',
  voiceSofia: 'Młoda i uwodzicielska kobieta',
  voiceVira: 'Ukraińska kobieta w średnim wieku',
  voiceOleksandr: 'Ukraiński mężczyzna w średnim wieku z opanowanym głosem',
  voiceAnton: 'Energetyczny mężczyzna',
  ...
  audioAllVoices: 'Wszystkie głosy',
  audioLanguageVoices: 'Głosy: {0}',
  
  // Voice descriptions
  voiceAutumnDescription: 'Miękka, jasna narracyjna kobieta',
  voiceLauraDescription: 'ASMR uspokajająca kobieta',
  voiceRogerDescription: 'Głęboki i autorytatywny',
  voiceBillDescription: 'Spokojny i uspokajający mężczyzna',
  voiceAdamDescription: 'Głęboki brytyjski mężczyzna',
  voiceAllissonDescription: 'Emocjonalna i ekspresyjna millennialka',
  voiceDakotaDescription: 'Afroamerykanka w średnim wieku',
  voiceEmilyDescription: 'Młoda przyjazna kobieta',
  voiceFrederickDescription: 'Profesjonalny, dobrze mówiący Brytyjczyk',
  voiceJohnDescription: 'Narracyjny mężczyzna w średnim wieku',
  voiceJasonDescription: 'Neutralny, jasny Australijczyk',
  voiceAgatkaDescription: 'Polska jasna i wesoła kobieta z jasnym głosem',
  voiceKarlDescription: 'Głęboki i jasny narracyjny mężczyzna',
  voiceLeonieDescription: 'Jasna i profesjonalna kobieta',
  voiceOttoDescription: 'Młody i towarzyski mężczyzna',
  voiceLenaDescription: 'Młoda i bardzo przyjazna kobieta',
  voiceLanaDescription: 'Medytacyjna miękka kobieta',
  voiceMilaDescription: 'Młoda kobieta',
  voiceMarioDescription: 'Miękki męski głos',
  voiceMarcoDescription: 'Dojrzały i zamyślony mężczyzna',
  voiceGiovanniDescription: 'Młody i przyjazny mężczyzna',
  voiceGiuseppeDescription: 'Starszy ekspresyjny mężczyzna',
  voiceSamantaDescription: 'Młoda i przyjazna kobieta w średnim wieku',
  voiceMartinDescription: 'Bardzo głęboki i wolny Hiszpan',
  voiceBrunoDescription: 'Szybki i neutralny mężczyzna',
  voiceRobertoDescription: 'Mężczyzna w średnim wieku z zainteresowaną narracją',
  voiceReginaDescription: 'Starsza i opanowana kobieta',
  voiceRosaDescription: 'Młoda i przyjazna kobieta',
  voiceSofiaDescription: 'Młoda i uwodzicielska kobieta',
  voiceViraDescription: 'Ukraińska kobieta w średnim wieku',
  voiceOleksandrDescription: 'Ukraiński mężczyzna w średnim wieku z opanowanym głosem',
  voiceAntonDescription: 'Energetyczny mężczyzna',
}; 